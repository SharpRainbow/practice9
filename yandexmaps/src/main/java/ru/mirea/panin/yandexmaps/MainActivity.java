package ru.mirea.panin.yandexmaps;
...
public class MainActivity extends AppCompatActivity implements UserLocationObjectListener {
    ...
    private final String MAPKIT_API_KEY = "01931f0e-3fa2-4120-bea3-cf63c5943347";
    private static final int REQUEST_CODE_PERMISSION_MAP = 100;
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CODE_PERMISSION_MAP) {
            if (grantResults.length > 0
                ...
                Toast.makeText(this, "Grant permission to access your location", Toast.LENGTH_SHORT).show();
            }
        }
    }
